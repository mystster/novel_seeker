...
_$NarouNovelInfoImpl _$$NarouNovelInfoImplFromJson(Map<String, dynamic> json) =>
    _$NarouNovelInfoImpl(
      ...
      isEnd: _intToBool((json['end'] as num).toInt()),
      generalAllNo: (json['general_all_no'] as num).toInt(),
      length: (json['length'] as num).toInt(),
      time: (json['time'] as num).toInt(),
      isStop: _intToBool((json['isstop'] as num).toInt()),
      isR15: json['isr15'] == null
          ? false
          : _intToBool((json['isr15'] as num).toInt()),
      isBl: _intToBool((json['isbl'] as num).toInt()),
      isGl: _intToBool((json['isgl'] as num).toInt()),
      isZankoku: _intToBool((json['iszankoku'] as num).toInt()),
      isTensei: _intToBool((json['istensei'] as num).toInt()),
      isTenni: _intToBool((json['istenni'] as num).toInt()),
...
Map<String, dynamic> _$$NarouNovelInfoImplToJson(
    ...
    <String, dynamic>{
      ...
      'end': _boolToInt(instance.isEnd),
      'general_all_no': instance.generalAllNo,
      'length': instance.length,
      'time': instance.time,
      'isstop': _boolToInt(instance.isStop),
      'isr15': _boolToInt(instance.isR15),
      'isbl': _boolToInt(instance.isBl),
      'isgl': _boolToInt(instance.isGl),
      'iszankoku': _boolToInt(instance.isZankoku),
      'istensei': _boolToInt(instance.isTensei),
      'istenni': _boolToInt(instance.isTenni),
