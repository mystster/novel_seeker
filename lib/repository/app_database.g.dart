...
class $NarouNovelContentsTable extends NarouNovelContents
  ...
  @override
  late final GeneratedColumnWithTypeConverter<ReadingStatus, int>
      readingStatus = GeneratedColumn<int>('reading_status', aliasedName, false,
              type: DriftSqlType.int, requiredDuringInsert: true)
  ...
  NarouNovelContent map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return NarouNovelContent(
      ...
      readingStatus: $NarouNovelContentsTable.$converterreadingStatus.fromSql(
          attachedDatabase.typeMapping.read(
              DriftSqlType.int, data['${effectivePrefix}reading_status'])!),
  ...
  static JsonTypeConverter2<ReadingStatus, int, int> $converterreadingStatus =
...
class NarouNovelContentsCompanion extends UpdateCompanion<NarouNovelContent> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (readingStatus.present) {
      map['reading_status'] = Variable<int>($NarouNovelContentsTable
...
class $$NarouNovelContentsTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<ReadingStatus, ReadingStatus, int>
      get readingStatus => $composableBuilder(
...
class $$NarouNovelContentsTableOrderingComposer
  ...
  ColumnOrderings<int> get readingStatus => $composableBuilder(
      column: $table.readingStatus,
      builder: (column) => ColumnOrderings(column));
...
class $$NarouNovelContentsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<ReadingStatus, int> get readingStatus =>
      $composableBuilder(
...
const databaseProvider = DatabaseFamily();

/// See also [database].
class DatabaseFamily extends Family<AppDatabase> {
  /// See also [database].
  ...
  @override
  DatabaseProvider getProviderOverride(
    covariant DatabaseProvider provider,
  ) {
    return call(
  ...
  @override
  String? get name => r'databaseProvider';
}
...
class DatabaseProvider extends Provider<AppDatabase> {
    ...
    bool isTesting = false,
          ...
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$databaseHash,
          dependencies: DatabaseFamily._dependencies,
          allTransitiveDependencies: DatabaseFamily._allTransitiveDependencies,
          isTesting: isTesting,
        );
  ...
  Override overrideWith(
    AppDatabase Function(DatabaseRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: DatabaseProvider._internal(
        (ref) => create(ref as DatabaseRef),
        from: from,
        name: null,
        dependencies: null,
  ...
  bool operator ==(Object other) {
    return other is DatabaseProvider && other.isTesting == isTesting;
  }

  @override
  int get hashCode {
    var hash = _SystemHash.combine(0, runtimeType.hashCode);
    hash = _SystemHash.combine(hash, isTesting.hashCode);
...
class _DatabaseProviderElement extends ProviderElement<AppDatabase>
  ...
  @override
  bool get isTesting => (origin as DatabaseProvider).isTesting;
}
// ignore_for_file: type=lint
